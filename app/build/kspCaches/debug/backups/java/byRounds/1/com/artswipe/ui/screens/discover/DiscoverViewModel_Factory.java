...
public final class DiscoverViewModel_Factory implements Factory<DiscoverViewModel> {
  ...
  public DiscoverViewModel_Factory(Provider<ArtworkRepository> artworkRepositoryProvider,
  ...
  public static DiscoverViewModel_Factory create(
      ...
      Provider<AuthRepository> authRepositoryProvider) {
    return new DiscoverViewModel_Factory(artworkRepositoryProvider, authRepositoryProvider);
  }

  public static DiscoverViewModel newInstance(ArtworkRepository artworkRepository,
      AuthRepository authRepository) {
    return new DiscoverViewModel(artworkRepository, authRepository);
  }
}
