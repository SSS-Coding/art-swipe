...
interface AicApi {
    ...
    suspend fun getArtworks(
        ...
        @Query("fields") fields: String = "id,title,artist_display,date_display,image_id,medium_display,style_title,department_title,description,classification_title,is_public_domain,is_boosted"
    ): AicResponse
}
